...
mixin IndicatorStateMixin<T extends StatefulWidget, V> on State<T> {
  TolyRefresh? refresher;

  RefreshConfigScope? configuration;
  TolyRefreshState? refresherState;
  ...
  void _updateListener() {
    configuration = RefreshConfigScope.of(context);
    refresher = TolyRefresh.of(context);
    refresherState = TolyRefresh.ofState(context);
