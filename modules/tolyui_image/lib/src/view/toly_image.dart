...
/// [Image]
class TolyImage extends StatefulWidget {
  TolyImage({
    super.key,
    required this.image,
    this.semanticLabel,
  ...
  @override
  _TolyImageState createState() => _TolyImageState();
  @override
...
class _TolyImageState extends State<TolyImage>
  ...
  late DisposableBuildContext<State<TolyImage>> _scrollAwareContext;
  ...
  @override
  TolyImage get imageWidget => widget;
  ...
  Widget build(BuildContext context) {
    ...
    if (current == null) {
      if (widget.enableLoadState) {
        current = TolyImage.globalStateWidgetBuilder(context, this);
      } else {
  ...
  @override
  void didUpdateWidget(TolyImage oldWidget) {
  ...
  void initState() {
    ...
    _scrollAwareContext = DisposableBuildContext<State<TolyImage>>(this);
  }
