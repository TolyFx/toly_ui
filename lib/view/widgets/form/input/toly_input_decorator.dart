...
class _RenderDecoration extends RenderBox
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    ...
    final double maxContentHeight =
        containerHeight - contentPadding.vertical - topHeight - densityOffset.dy;
  ...
  double _interpolateThree(
      double begin, double middle, double end, TextAlignVertical textAlignVertical) {
...
class _InputDecoratorState extends State<InputDecorator> with TickerProviderStateMixin {
  ...
  InputDecoration get decoration =>
      _effectiveDecoration ??= widget.decoration.applyDefaults(InputDecorationTheme());
  ...
  TextStyle _getFloatingLabelStyle(ThemeData themeData, InputDecorationTheme defaults) {
    TextStyle defaultTextStyle =
        MaterialStateProperty.resolveAs(defaults.floatingLabelStyle!, materialState);
    ...
    defaultTextStyle =
        defaultTextStyle.merge(decoration.floatingLabelStyle ?? decoration.labelStyle);
    ...
    if (themeData.useMaterial3) {
      if (decoration.filled!) {
        return border.copyWith(
          borderSide:
              MaterialStateProperty.resolveAs(defaults.activeIndicatorBorder, materialState),
        );
      } else {
        return border.copyWith(
      ...
      return border.copyWith(
        borderSide: BorderSide(
          ...
          width: ((decoration.isCollapsed ?? themeData.inputDecorationTheme.isCollapsed) ||
...
class InputDecorationTheme with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Duration>('hintFadeDuration', hintFadeDuration,
    ...
    properties
        .add(IntProperty('errorMaxLines', errorMaxLines, defaultValue: defaultTheme.errorMaxLines));
    ...
    properties
        .add(DiagnosticsProperty<bool>('isDense', isDense, defaultValue: defaultTheme.isDense));
    ...
    properties.add(DiagnosticsProperty<Color>('prefixIconColor', prefixIconColor,
    ...
    properties.add(DiagnosticsProperty<Color>('suffixIconColor', suffixIconColor,
    ...
    properties.add(DiagnosticsProperty<BorderSide>('outlineBorder', outlineBorder,
    ...
    properties.add(DiagnosticsProperty<InputBorder>('focusedErrorBorder', focusedErrorBorder,
        defaultValue: defaultTheme.focusedErrorBorder));
    properties.add(DiagnosticsProperty<InputBorder>('disabledBorder', disabledBorder,
    ...
    properties
        .add(DiagnosticsProperty<InputBorder>('border', border, defaultValue: defaultTheme.border));
